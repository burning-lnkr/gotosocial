...
//
// Delete domain silence with the given ID.
//
//	---
//	tags:
//	- admin
...
//	responses:
//		'200':
//			description: The domain silence that was just deleted.
//			schema:
...
func (m *Module) DomainSilenceDELETEHandler(c *gin.Context) {
	m.deleteDomainPermission(c, gtsmodel.DomainPermissionSilence)
}
